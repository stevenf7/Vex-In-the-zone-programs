...
//hello, here is our codes
//our robot has four main sections, Reverse double four bar as the main lift, "clawlift" (a 4 bar lift system) as our secondary lift to move the
//cone intake, a mobile goal intake to move the mobile goals and drive.
int optimalL;
int optimalR;
int ArmUpdateL;
int ArmUpdateR;
...
//let int RD4B be teh PID value set by the PID, and this part will be placed in the beginning of the PID calculation
int k_RD4B= 1.1;
while (true){
...
motor [TR] =RD4B * k_RD4B;
motor [TL] = RD4B /k_RD4B;
}
else if ((SensorValue[ArmPotL]+90) > (SensorValue[ArmPotR])){
motor [TL] = RD4B * k_RD4B;
motor [TR] = RD4B /k_RD4B;
}
else	{
